...
export default function StudentsDashboard() {
  ...
  const [currentChangedUser, setCurrentChangedUser] = useState(allUserInfo);
  ...
  const handleCheckUserEmpty = () => {
    Object.entries(currentChangedUser).forEach(([_, value]) => {
      if (!value) {
        return true;
      }
    });
  ...
  const handleSendNoticeEmail = () => {
    ajax("put", `/api/v1/admin/mail/${currentChangedUser.studentId}`, null, jwt)
      .then((response) => {
        toast({
          title: "Cập nhật người dùng",
      ...
      .catch((error) => {
        toast({
          variant: "destructive",
          title: "Cập nhật người dùng",
          description: "Không thể gửi mail cho sinh viên 🥲",
        });
      });
  };
      ...
      {users?.length > 0 ? (
        <>
                  ...
                  <div className="flex w-full justify-between items-center px-10 py-4 bg-muted rounded-md border">
                    ...
                    <div className="flex items-center gap-2">
                      <Dialog>
                        ...
                        <DialogContent>
                          <DialogHeader className="max-h-96 overflow-scroll">
                            ...
                            <div className="px-[5%]">
                              <div className="w-full flex flex-col">
                                ...
                                <div className="w-full grid lg:grid-cols-7 gap-2.5 grid-cols-1 items-center border-b py-6">
                                  ...
                                  <span className="lg:col-span-5" id="phoneNum">
                                    {currentChangedUser.phoneNum ? (
                                      currentChangedUser.phoneNum
                                    ) : (
                                      <span>
                                        Chưa cập nhật
                                ...
                                <div className="w-full grid lg:grid-cols-7 gap-2.5 grid-cols-1 items-center border-b py-6">
                                  ...
                                  <span className="lg:col-span-5" id="address">
                                    {currentChangedUser.address ? (
                                      currentChangedUser.address
                                    ) : (
                                      <>
                                        Chưa cập nhật
                                ...
                                <div className="w-full grid lg:grid-cols-7 gap-2.5 grid-cols-1 items-center border-b py-6">
                                  ...
                                  <span className="lg:col-span-5" id="socialId">
                                    {currentChangedUser.socialId ? (
                                      currentChangedUser.socialId
                                    ) : (
                                      <span>
                                        Chưa cập nhật
                                ...
                                <div className="w-full grid lg:grid-cols-7 gap-2.5 grid-cols-1 items-center border-b py-6">
                                  ...
                                  <span className="lg:col-span-5" id="dadName">
                                    {currentChangedUser.dadName ? (
                                      currentChangedUser.dadName
                                    ) : (
                                      <span>
                                        Chưa cập nhật
                                ...
                                <div className="w-full grid lg:grid-cols-7 gap-2.5 grid-cols-1 items-center border-b py-6">
                                  ...
                                  <span
                                    ...
                                    id="dadPhoneNum"
                                  >
                                    {currentChangedUser.dadPhoneNum ? (
                                      currentChangedUser.dadPhoneNum
                                    ) : (
                                      <span>
                                        Chưa cập nhật
                                ...
                                <div className="w-full grid lg:grid-cols-7 gap-2.5 grid-cols-1 items-center border-b py-6">
                                  ...
                                  <span className="lg:col-span-5" id="dadYob">
                                    {currentChangedUser.dadYob ? (
                                      currentChangedUser.dadYob
                                    ) : (
                                      <span>
                                        Chưa cập nhật
                                ...
                                <div className="w-full grid lg:grid-cols-7 gap-2.5 grid-cols-1 items-center border-b py-6">
                                  ...
                                  <span className="lg:col-span-5" id="momName">
                                    {currentChangedUser.momName ? (
                                      currentChangedUser.momName
                                    ) : (
                                      <span>
                                        Chưa cập nhật
                                ...
                                <div className="w-full grid lg:grid-cols-7 gap-2.5 grid-cols-1 items-center border-b py-6">
                                  ...
                                  <span
                                    ...
                                    id="momPhoneNum"
                                  >
                                    {currentChangedUser.momPhoneNum ? (
                                      currentChangedUser.momPhoneNum
                                    ) : (
                                      <span>
                                        Chưa cập nhật
                                ...
                                <div className="w-full grid lg:grid-cols-7 gap-2.5 grid-cols-1 items-center border-b py-6">
                                  ...
                                  <span className="lg:col-span-5" id="momYob">
                                    {currentChangedUser.momYob ? (
                                      currentChangedUser.momYob
                                    ) : (
                                      <span>
                                        Chưa cập nhật
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            {handleCheckUserEmpty ? (
                              <Button onClick={handleSendNoticeEmail}>
                                Nhắc nhở
                              </Button>
                            ) : null}
                            <DialogClose asChild>
                              <Button
                                variant="outline"
                                onClick={() =>
                                  setCurrentChangedUser(allUserInfo)
                                }
                              >
                                Hủy
                              </Button>
          ...
          <div className="my-4 w-full flex items-center justify-end">
            <Dialog>
              <DialogTrigger asChild>
                <Button onClick={() => setCurrentChangedUser(allUserInfo)}>
                  Thêm mới
              ...
              <DialogContent>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <DialogClose asChild>
                    <Button
                      variant="outline"
                      onClick={() => setCurrentChangedUser(allUserInfo)}
                    >
                      Hủy
                    </Button>
                  </DialogClose>
